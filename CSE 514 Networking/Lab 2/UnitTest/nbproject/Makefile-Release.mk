...
${TESTDIR}/tests/Test_Node1.o: tests/Test_Node1.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Node1.o tests/Test_Node1.c


${TESTDIR}/tests/Test_Node2.o: tests/Test_Node2.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Node2.o tests/Test_Node2.c


${TESTDIR}/tests/Test_Node3.o: tests/Test_Node3.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Test_Node3.o tests/Test_Node3.c
