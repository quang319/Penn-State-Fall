...
${OBJECTDIR}/node0.o: node0.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node0.o node0.c

${OBJECTDIR}/node1.o: node1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node1.o node1.c

${OBJECTDIR}/node2.o: node2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node2.o node2.c

${OBJECTDIR}/node3.o: node3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node3.o node3.c

${OBJECTDIR}/prog3.o: prog3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/prog3.o prog3.c
...
${OBJECTDIR}/node0_nomain.o: ${OBJECTDIR}/node0.o node0.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node0_nomain.o node0.c;\
	else  \
...
${OBJECTDIR}/node1_nomain.o: ${OBJECTDIR}/node1.o node1.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node1_nomain.o node1.c;\
	else  \
...
${OBJECTDIR}/node2_nomain.o: ${OBJECTDIR}/node2.o node2.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node2_nomain.o node2.c;\
	else  \
...
${OBJECTDIR}/node3_nomain.o: ${OBJECTDIR}/node3.o node3.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/node3_nomain.o node3.c;\
	else  \
...
${OBJECTDIR}/prog3_nomain.o: ${OBJECTDIR}/prog3.o prog3.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/prog3_nomain.o prog3.c;\
	else  \
