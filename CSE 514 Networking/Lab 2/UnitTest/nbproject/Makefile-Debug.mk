...
${OBJECTDIR}/testmain.o: testmain.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testmain.o testmain.c
...
${OBJECTDIR}/testmain_nomain.o: ${OBJECTDIR}/testmain.o testmain.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/testmain.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testmain_nomain.o testmain.c;\
	else  \
	    ${CP} ${OBJECTDIR}/testmain.o ${OBJECTDIR}/testmain_nomain.o;\
	fi
